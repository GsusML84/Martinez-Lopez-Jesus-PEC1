...
```{r descarga con metabolomicsWorkbenchR}
...
```{r M138 boxplot, warning=FALSE, echo=FALSE, fig.height=3.5}
...
```{r M8 boxplot, warning=FALSE, echo=FALSE, fig.height=3.5}
sample_metadata <- colData(se)
...
```{r PomaBoxplots, echo=FALSE, fig.height=8}
...
```{r PomaDensity, echo=FALSE, fig.height=6}
